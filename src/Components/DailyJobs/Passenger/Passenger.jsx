...
const Passenger = () => {
  return (
    <div className='flex flex-col gap-6 mt-20 mx-10 rounded-md bg-box-background shadow-lg shadow-box-shadow p-6'> 
        <div className='bg-green-800 rounded-md shadow-lg shadow-slate-800 text-2xl -mt-10 w-fit px-5 h-16 flex items-center justify-center text-white'> Passengers </div>
        <div className='flex justify-between bg-slate-200 p-4 px-6 items-center '> 
            <p> Total Records: 0 </p>
            <Link className='bg-green-800 w-28 rounded-md shadow-lg shadow-slate-800 p-2 px-4 text-white' to={'/passenger'}>+ Create </Link>
