...
const CreateTrip = () => {
  ...
  return (
    <div className="mx-10 mt-20">
      <Link to={'/trips'} 
      className='bg-green-800 rounded-md shadow-lg shadow-slate-800 text-2xl -mt-10 w-20 h-16 
      ...
      <div className="mt-10">
        <form className="flex justify-between">
          <div className="w-full gap-52 grid grid-cols-2 relative">
            ...
            <input className="border-b-2 border-green-700 outline-none  bg-inherit " type="date" />  
